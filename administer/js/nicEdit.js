...
var nicUploadButton=nicEditorAdvancedButton.extend(
    {
        nicURI:"http://news.armeniatv.com/administer/ajax.php",addPane:function(){
        ...
        if(this.uri==this.nicURI){
            A.write('<div style="position: absolute; margin-left: 160px;">Iguan Uploader</div>')
        }
        ...
        this.myStatus=new bkElement("div",this.myDoc).setStyle({textAlign:"center",fontSize:"14px"}).appendTo(this.myBody)},startUpload:function(){
            this.myForm.setStyle({display:"none"});
            this.myStatus.setContent('<img src="http://news.armeniatv.com/images/loader.gif" style="float: right; margin-right: 40px;" /><strong>Uploading...</strong><br />Please wait');
            this.myForm.submit();
            ...
            if(this.pane&&this.pane.pane){
                ...
                var A=new bkElement("script").setAttributes(
                    {type:"text/javascript",src:this.uri+"?check="+this.myID+"&rand="+Math.round(Math.random()*Math.pow(10,15))}
            ...
            if(C==false){
                ...
                if(C.url){
                    ...
                    if(C.error){
                        this.requestInterval=false;this.setProgress(100);
