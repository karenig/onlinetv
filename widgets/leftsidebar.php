<div><a href="http://www.youtube.com/watch?v=gQif1cy73G0" target="_blank"><img src="/images/hayfest.jpg" title="led.am" width="200" /></a></div>
<div style="color: #FF6600;   font-size: 14px;    font-weight: bold;    letter-spacing: 2px; margin: 15px 0 6px 0;"> Լրահոս</div>
<?


//$news_last = select_data_last();
...
switch ($items['type'])
{
   case "news":     $lnk='Լուրեր';   break;
   case "blog":     $lnk='Բլոգեր';   break;
   case "eighteen":     $lnk='18';   break;
   case "interetsing":     $lnk='Հետաքրքիր է';   break;
   case "business":     $lnk='Բիզնես';   break;
   case "xohanoc":     $lnk='Խոհանոց';   break;
   case "important_news":     $lnk='Կարևոև տեղեկատվություն';   break;
...
<div class="blck"> 
 <table>
 <tr>
 <td  valign="top" width="51"><img src="<?=$items['filepath']?>" width="50" alt="title"/></td>
 <td valign="top">
 <span class="datetime"><?=$dates->format('H:i')?> - </span>
 <span ><a class="first_block" href="?view=<?=$lnk;?>&t=<?=$items['title'];?>"><?=$items['title'];?></a></span>
</td>
 </tr>
  <tr><td colspan="2"><span class="first_block_two"><?=$items['totalcount'];?></span></td></tr>
 </table>
</div>
<? endforeach;  ?>
